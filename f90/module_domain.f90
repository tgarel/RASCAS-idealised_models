...
contains
  ...
  subroutine domain_get_bounding_box(dom,xmin,xmax,ymin,ymax,zmin,zmax)
    ...
    case('sphere')
       ...
       zmax = dom%sp%center(2) + dom%sp%radius
       zmin = dom%sp%center(2) - dom%sp%radius
    case('shell')
       ...
       zmax = dom%sh%center(2) + dom%sh%r_outbound
       zmin = dom%sh%center(2) - dom%sh%r_outbound
    case('cube')
       ...
       zmax = dom%cu%center(2) + dom%cu%size*0.5d0
       zmin = dom%cu%center(2) - dom%cu%size*0.5d0
    case('slab')
       xmax = 1.0d0
       xmin = 0.0d0
       ymax = 1.0d0
