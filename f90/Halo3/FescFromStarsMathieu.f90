program main
  ...
  ! --------------------------------------------------------------------------
  ! --- inputs 
  character(2000)           :: DataDir      = '/scratch/chuniaud/test_fesc/Halo3/'                      ! where input files below are 
  character(2000)           :: RaysICFile = 'position_Halo3_lum_groups.dat'      ! the file containing photons to cast.
