...
contains
  ...
  subroutine overwrite_gas(g,x_leaf,leaf_level,nleaf)
    ...
    case('sphere_homogen_steidel_ndens')      
       do ileaf=1,nleaf
          dx_cell = 0.5d0**leaf_level(ileaf)
          call sphere_homogen_steidel_ndens(g(ileaf)%v(1),g(ileaf)%v(2),g(ileaf)%v(3),g(ileaf)%nHI,g(ileaf)%dopwidth,x_leaf(ileaf,1),x_leaf(ileaf,2),x_leaf(ileaf,3),dx_cell,g(ileaf)%ndust)
       end do
