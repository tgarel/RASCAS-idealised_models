module module_FeII_2261_model ! Fe_II UV4
  ...
  ! This module describes the absorption of photons by FeII from level  3d^6 4s 6D 9/2 to level 3d^6 4p 4F^0 9/2.
  ...
  public :: get_tau_FeII_2261, scatter_FeII_2261, read_FeII_2261_params, print_FeII_2261_params
...
contains
  ...
  function get_tau_FeII_2261(nFeII, vth, distance_to_border_cm, nu_cell)
    ...
    real(kind=8)            :: delta_nu_doppler,x_cell,sigma,a,h_cell,get_tau_FeII_2261
  ...
  subroutine read_FeII_2261_params(pfile)
  ...
  end subroutine read_FeII_2261_params



  subroutine print_FeII_2261_params(unit)
  ...
  end subroutine print_FeII_2261_params
