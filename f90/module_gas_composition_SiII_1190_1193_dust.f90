...
contains
  ...
  subroutine gas_from_ramses_leaves_ions(repository,snapnum,nleaf,nvar,ramses_var,SiII_density,g)
    ...
    if (gas_overwrite) then
       ...
       write(*,*) '-- module_gas_composition_SiII_1190_1193_dust : extracting nHI and T from ramses '
  ...
  function  gas_get_tau(cell_gas, distance_cm, nu_cell)
    ...
    real(kind=8)            :: tau_SiII_1190, tau_SiII_1193, tau_dust
    ...
    gas_get_tau = tau_SiII_1190 + tau_SiII_1193 + tau_dust
