program main
  ...
  character(2000)           :: PhotonICFile = 'LyaPhotIC_5M.recLya.1' !Photon_IC_file.dat'      ! the file containing photons to cast (incl. full path)
  ...
  ! --- outputs
  character(2000)           :: fileout = 'LyaPhotIC_5M.recLya.result.1 ' !photons_done.dat'   ! output file ...
  ! --- miscelaneous
  integer(kind=4)           :: nbundle = 10
  logical                   :: verbose = .true. !.false. 
  ! --------------------------------------------------------------------------
