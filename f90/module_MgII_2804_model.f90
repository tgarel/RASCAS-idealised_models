module module_MgII_2804_model
  ...
  !--PEEL--
  public :: MgII_2804_peeloff_weight
  !--LEEP--
...
contains
  ...
  subroutine scatter_MgII_2804(vcell,vth,nu_cell,k,nu_ext,iran)
    ...
    k = knew
      ...
      !--PEEL--
  function MgII_2804_peeloff_weight(vcell,vth,nu_ext,kin,kout,iran)
    ...
    real(kind=8),intent(in)                 :: vth
    integer(kind=4),intent(inout)           :: iran
    real(kind=8)                            :: MgII_2804_peeloff_weight
    real(kind=8)                            :: delta_nu_doppler, a, x_cell, upar, ruper
    real(kind=8)                            :: r2,uper, nu_atom, mu, bu, scalar
    ...
    ! 4/ determine direction of scattered photon
    MgII_2804_peeloff_weight = 0.5d0  ! P(mu) for isotropic phase function
  ...
  end function MgII_2804_peeloff_weight
!--LEEP--
