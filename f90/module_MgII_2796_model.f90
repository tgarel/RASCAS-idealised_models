module module_MgII_2796_model
  ...
  ! This module describes the absorption of photons by MgII from level 2p^6 3p 2S 1/2 to level 2p^6 3p 2P^0 3/2
...
contains
  ...
  function get_tau_MgII_2796(nMgII, vth, distance_to_border_cm, nu_cell)
    ...
    real(kind=8)            :: delta_nu_doppler,x_cell,sigma,a,h_cell,get_tau_MgII_2796
