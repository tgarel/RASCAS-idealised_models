program main
  ...
  ! --------------------------------------------------------------------------
  ! --- inputs 
  character(2000)           :: DataDir      = '/scratch/chuniaud/test_fesc/Halo2/'                      ! where input files below are 
  character(2000)           :: RaysICFile = 'positionHalo2_lum_groups.dat'      ! the file containing photons to cast.
