module module_FeII_2587_model ! Fe_II UV1
  ...
  real(kind=8),parameter :: A41            = 8.94d7                   ! spontaneous decay [/s]
  ...
  real(kind=8),parameter :: A42_over_A42_plus_A43 = A42 / (A42+A43)
  
  public :: get_tau_FeII_2587, scatter_FeII_2587
...
contains
  ...
  function get_tau_FeII_2587(nFeII, vth, distance_to_border_cm, nu_cell)
    ...
    real(kind=8)            :: nu_D,x_cell,sigma,a,h,get_tau_FeII_2587
  ...
  subroutine scatter_FeII_2587(vcell,vth,nu_cell,k,nu_ext,iran)
    ...
    r2 = ran3(iran)       
    else if (r2 <= A42_over_A42_plus_A43) then
