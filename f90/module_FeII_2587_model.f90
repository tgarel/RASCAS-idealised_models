module module_FeII_2587_model ! Fe_II UV1
  ...
  real(kind=8),parameter :: A42            = 1.23d8 ! 1.2d8                   ! spontaneous decay [/s]

  ! transition between levels 4 and 3
  real(kind=8),parameter :: lambda34       = 2632.108d0 ! 2632.11d0                ! transition wavelength [A]
  real(kind=8),parameter :: lambda34_cm    = lambda34 / cmtoA         ! [cm]
  real(kind=8),parameter :: nu34           = clight / lambda34_cm     ! [Hz]
  real(kind=8),parameter :: A43            = 6.21d7 ! 6.29d7                   ! spontaneous decay [/s]
